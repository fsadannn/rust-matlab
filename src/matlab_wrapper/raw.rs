...
impl mxArray {
    ...
    pub fn dimensions(&self) -> &[usize] {
        unsafe {
            std::slice::from_raw_parts(
                mxGetDimensions(self),
                mxGetNumberOfDimensions(self)
                    .try_into()
                    .expect("Number of dimensions should be positive integer"),
            )
        }
    }
    ...
    pub fn numel(&self) -> usize {
        unsafe {
            mxGetNumberOfElements(self)
                .try_into()
                .expect("Number of elements should be positive integer")
        }
    }
