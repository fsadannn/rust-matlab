...
mod helpers;
mod matlab_wrapper;
use matlab_wrapper::mex::mexErrMsgTxt;
use matlab_wrapper::mx::mxCreateDoubleMatrix;
use std::ops::Rem;
use std::os::raw::c_int;

use crate::helpers::{daxpy, scale_unrolled, setIdentity2_unrolled};
use crate::matlab_wrapper::blas::{dgemm, dgesv};
use crate::matlab_wrapper::raw::{Rhs, mxArray, mxComplexity_mxREAL};
...
pub extern "C" fn mexFunction(
    ...
    /* Ak = A*(1/s) */
    scale_unrolled(A, Ak, total_size, is);
    ...
    daxpy(c, Ak, P, total_size);
    let mut mc: f64 = -c;
    daxpy(mc, Ak, Q, total_size);
    ...
    match p {
        2 => {
            ...
            daxpy(c, Aux, P, total_size);
            daxpy(c, Aux, Q, total_size);
        }
        3 => {
